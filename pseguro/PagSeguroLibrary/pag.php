...
$idTurista =  2;
                ...
                $turista = "SELECT *
                FROM turistas
                WHERE turistas.id =:id LIMIT 1 ";

                $resu = $conn->prepare($turista);
                $resu->bindParam(':id', $idTurista, PDO::PARAM_INT);
                $resu->execute();
                if ($resu->rowCount() == 0) {
    ...
    <form method="POST">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <label for="first_name">Primeiro Nome</label>
                    <input type="text" name="valor" id="valor" class="form-control" placeholder="Primeiro nome" value="<?php
                    if (isset($data['valor'])) {
                    echo $data['valor'];
                    }
                    ?>" autofocus >
        ...
        <div class="panel-body">
            <div class="panel">
                    ...
                    <input type="hidden" name="brand">
                        ...
                        <input type="hidden" name="amount" value="<?php echo number_format($custoEvento, 2, ",", ".");?>">
