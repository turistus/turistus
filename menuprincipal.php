...
<header class="p-2 mb-2 border-bottom header" style="font-family: 'EB Garamond'; font-size: 20px;  background-color:#f1f1f3;">
  <div class="container" >
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start" >
      ...
      <ul  class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="#" class="nav-link px-2 link-dark"></a></li>
        <li><a href="pg/pontos-turisticos.php" class="nav-link px-2 link-secondary"><ion-icon name="image-outline"></ion-icon> Pontos turísticos</a></li>
        ...
        ?>
          ...
          <button type="button" class="btn btn-outline-primary">
            <div class='dropdown text-end'>
              <a href='#' class='d-block link-dark text-decoration-none dropdown-toggle' id='dropdown1' data-bs-toggle='dropdown' aria-expanded='false'>
              Cadastre - se </a>
