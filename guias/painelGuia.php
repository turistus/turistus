                                                      ...
                                                      <div class="card-body" >
                                                        ...
                                                        <p class="text-muted">Lista de pedidos feitos a serem analisados e aceitos ou remarcados conforme sua agenda.</p>
                                                              <ul style="display: none;">
                                                                <li style=" background: #008080; height: 50px; width: 50px; border-radius: 5px; border:solid 1px black; ">  </li>Feito Pedido
                                                                <li style=" background: #008080; height: 50px; width: 50px; border-radius: 5px; border:solid 1px black; ">  </li>Gerou Pedido
                                                                <li style=" background: #000000; height: 50px; width: 50px; border-radius: 5px; border:solid 1px black; ">  </li>Pedido Expirado
                                                                <li style=" background: #40E0D0; height: 50px; width: 50px; border-radius: 5px; border:solid 1px black; ">  </li>Pedido em Análise
                                                                <li style=" background: #32CD32; height: 50px; width: 50px; border-radius: 5px; border:solid 1px black; ">  </li>Pedido Pago
                                                              </ul>
