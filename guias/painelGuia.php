              ...
              <div class="dialog">
                      <div class="modal-content">
                          <div class="modal-body">
                              ...
                              <p> Cód.Guia: <b>00<?php echo $Uid?></b> Plano Atual: <b><span style="border-radius: 10px; border: black solid 1px; padding:2px;">BASICO</span></b></p>
                                                      ...
                                                      <div class="card-body" >
                                                        ...
                                                        <table class="table table-responsive{-sm|-md|-lg|-xl} table-hover" style="width: 100%;" >
                                                            ...
                                                            FROM payments_picpays AS pay
                                                                ...
                                                                WHERE pay.guiaId = $Uid AND payments_statu_Id <= 4 AND confirmado = 0 ORDER BY idagendado DESC Limit 10";
