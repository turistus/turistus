              ...
              <div class="dialog">
                      <div class="modal-content">
                          <div class="modal-body">
                              ...
                              <p> Guia: <b>00<?php echo $Uid?></b> Plano: <b><span style="border-radius: 10px; border: black solid 1px; padding:3px;">BÁSICO</span></b> <a href="upgradePlanos.php"><button class="btn btn-sucess">  +Upgrade</button></a></p>
                                                      ...
                                                      <div class="card-body" >
                                                        ...
                                                        <table class="table table-responsive{-sm|-md|-lg|-xl} table-hover" style="width: 100%;" >
                                                            ...
                                                            while ($row_payment = $result_payments->fetch(PDO::FETCH_ASSOC)) {
                                                                ...
                                                                echo "<td style='font-size: 10px; '>$idagendado<br></td>";
