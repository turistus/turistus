          ...
          ?>
            <div class="col mb-4 text-center">
              ...
              <div class="card" style="padding: 20px; text-align: center; background-color: #f1f1f3;">
                ...
                <a href="./usuarios/funcoes/avaliarGuia.php" <img style="height: 140px; max-height: 200px; max-width: 400px; margin:auto; border:1px solid green; box-shadow: 3px 2px 5px black;" src='<?php echo "./images/guias/$id/$image"; ?>' class="card-img-top" alt="...">
