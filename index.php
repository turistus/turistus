                          ...
                          <div class="card-body d-flex flex-column ">
                            ...
                            <?php
                              ...
                              foreach ($midias as $midia) {
                                ...
                                if ($extensao == 'mp4') { ?>
                                      <div>
                                        <video id="video-<?php echo $midia; ?>" src="./images/eventos/<?php echo $id . '/' . $midia; ?>" controls style="height: 190px; width: 235px; text-align: center; margin-left:auto; margin-right: auto; border-radius: 10px;"></video>
                                        <script>
