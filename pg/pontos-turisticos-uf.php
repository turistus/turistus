            ...
            <br>
                ...
                if(!empty($_GET['search'])){
                   // echo "contem algo, no pesquisar";
                    $palavra = $_GET['search'];
                    $query = "SELECT id, name, image, cidade FROM pontosturisticos WHERE pontosturisticos.name LIKE '%$palavra%' OR pontosturisticos.cidade LIKE '%$palavra%' AND WHERE uf = '$uf' ORDER BY name ASC";
