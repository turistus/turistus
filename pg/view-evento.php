        ...
        <div class="col-md-12">
            <div class="carousel form-inline" style="border: 1px solid black;">
                ...
                foreach ($midias as $midia) {
                    ...
                    if ($extensao == 'mp4') { ?>
                        <div>
                            <video id="video-<?php echo $midia; ?>" src="../images/eventos/<?php echo $id . '/' . $midia; ?>" controls width="640" style="margin: auto; height: 300px; text-align: center; object-fit: cover; border-radius: 10px;"></video>
                            <script>
                    ...
                    <!-- Lado Direito -->
                        <div class="col-md-6" style="border: 0,5px solid black;">
                            ...
                            <div class="col-md-12 ">
                                ...
                                <h3>Município <?php echo $cidade?> - <?php echo $uf?></h3>
                                ...
                                <div class="row">
                                        ...
                                        <h6><b>Pague com Pix </b></h6>
                                            <form action="pagamentoEventoForm.php?id=<?php echo $id; ?>" method="POST">
                                                ...
                                                <input type="hidden" name="opcaoSelecionada" id="opcaoSelecionada" value="<?php echo $opc;?>"/>
