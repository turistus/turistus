        ...
        <div class="col-md-12">
            <div class="carousel form-inline" style="border: 1px solid black;">
                ...
                foreach ($midias as $midia) {
                    ...
                    if ($extensao == 'mp4') { ?>
                        <div>
                            <video id="video-<?php echo $midia; ?>" src="../images/eventos/<?php echo $id . '/' . $midia; ?>" controls style=" height: 300px; text-align: center; margin-left:auto; border-radius: 10px;"></video>
                            <script>
