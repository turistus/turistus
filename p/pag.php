...
<html lang="pt-br">
    ...
    <div class="container">
        ...
        <form name="formPagamento" action="" id="formPagamento">
            ...
            <label>Nome</label>
            <input class="form-group" type="text" name="senderName" id="senderName" placeholder="Nome completo" value="Jose Comprador" required><br><br>

            <label>Data de Nascimento</label>
            <input class="form-group type="datetine" name="creditCardHolderBirthDate" id="creditCardHolderBirthDate" placeholder="Data de Nascimento. Ex: 12/12/1912" value="27/10/1987" required><br><br>

            <label>CPF</label>
            <input class="form-group type="text" name="senderCPF" id="senderCPF" placeholder="CPF sem traço" value="22111944785" required><br><br>

            <label>Telefone</label>
            <input class="form-group type="text" name="senderAreaCode" id="senderAreaCode" placeholder="DDD" value="11" required>
            <input class="form-group type="text" name="senderPhone" id="senderPhone" placeholder="Somente número" value="56273440" required><br><br>
